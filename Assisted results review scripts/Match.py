...
def main(csv1_path, csv2_path, output_dir='output', similarity_threshold=0.3):
    ...
    # Get the filenames without paths or extensions for the output filename
    file1_name = os.path.basename(csv1_path)
    file2_name = os.path.basename(csv2_path)
    file1_name_no_ext = os.path.splitext(file1_name)[0]
    file2_name_no_ext = os.path.splitext(file2_name)[0]
    
    # Create the output filename
    output_filename = f"{file1_name_no_ext} {file2_name_no_ext} match.html"
